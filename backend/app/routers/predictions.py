...
def predict():
    ...
    return jsonify(
        {"area_id": area_id, "date": date, "predictions": results, "data_source": prediction_service.get_data_source()}
    )
...
def predict_location():
    ...
    lat/lon instead of one of the 10 curated area IDs. Candidates are gated
    ...
    result["data_source"] = prediction_service.get_data_source()
